...
public class ASCIIDecrypt extends JFrame{
    ...
    public void result(){
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                	ASCIIDecrypt frame = new ASCIIDecrypt();
...
setTitle("S-DES");
        ...
        JLabel lblNewLabel = new JLabel("ASCII解密界面");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                new SimpleDES().decryptASCII(t1);
                JOptionPane.showMessageDialog(null,"明文为："+new SimpleDES().decryptedResult); 
            }
        });
    }
}
